...
*/
(function(t,u,l){function E(c){i.logging&&t.console&&t.doNothing&&t.doNothing(c)}function U(c,g){var e=[];return{storage:e,width:c,height:g,fillRect:function(){e.push({type:"function",name:"fillRect",arguments:arguments})},drawImage:function(){e.push({type:"function",name:"drawImage",arguments:arguments})},fillText:function(){e.push({type:"function",name:"fillText",arguments:arguments})},setVariable:function(a,d){e.push({type:"variable",name:a,arguments:d})}}}var i={},T,L;i.Util={};i.Util.backgroundImage=
