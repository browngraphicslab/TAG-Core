...
(function () {
    ...
    \*/
    R.ninja = function () {
        oldRaphael.was ? (g.win.Raphael = oldRaphael.is) : Raphael = undefined;
        return R;
    };
    /*\
     * Raphael.st
        ...
        for (var att in params) {
            if (params[has](att)) {
                ...
                switch (att) {
                    ...
                    default:
                        att == "font-size" && (value = parseFloat(value) + "px"); // bleveque -- text inks were scaling less smoothly before, since font sizes were getting parsed to ints
