    ...
    function ResumableChunk(resumableObj, fileObj, offset, callback){
      ...
      $.test = function(){
        ...
        $h.each(customQuery, function(k,v){
          ...
          if(k === 'Type') {
            params.push([encodeURIComponent(k), encodeURIComponent('ResumableUpload')].join('='));
          }else {
      ...
      $.send = function(){
		...
		*******************ORIGINAL*******************/
        ...
        $.xhr.setRequestHeader("Access-Control-Allow-Headers", "*"); //to enable CORS
...
/********New Resumable Object****************
var r = new Resumable({
		target: 'http://localhost:8080/?Type=ResumableUpload', //headcoded target, probably add 'Type=ResumableUpload' as a query option instead
		query: {},
		maxChunkRetries: 2,
		maxFiles: 3,
		...
		chunkSize: 1 * 1024 * 1024,
		testChunks: false //makes sure that a preliminary GET method is not sent. Needs to be removed to allow for reuploads
	});
*******************************************/