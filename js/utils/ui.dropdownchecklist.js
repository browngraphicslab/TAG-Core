...
**********/	
	        ...
	        item.click(function(e) {
				...
				if (!anItem.hasClass("ui-state-disabled") ) {
	                ...
	                // EDIT MADE HERE BY NATE - prevents deselection of radio buttons when empty part of div clicked.
	                // aCheckBox.prop("checked", !checked); // Old code.
	                if (self.isMultiple || !aCheckBox.prop('checked')) {
