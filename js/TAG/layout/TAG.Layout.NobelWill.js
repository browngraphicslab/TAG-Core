        ...
        */
    	...
    	var texts = [//big chunks of text per popup
			[
				...
				"Alfred Nobel was born in Stockholm in 1833, grew up in St. Petersburg, Russia, and later lived in Hamburg, Paris, and San Remo. He spent a large part of his life traveling. His inventions in the field of explosives, including dynamite, laid the groundwork for an extensive industrial enterprise. At his death in 1896, he left behind a huge fortune. In his will, Nobel left the bulk of his wealth to fund prizes in five fields: physics, chemistry, physiology or medicine, literature, and peace.",
				"Robert Nobel (1829–1896), Alfred Nobel’s oldest brother, was involved in the early establishment of the explosives industry, and started a dynamite factory outside Helsinki. He was the head of the dynamite factory at Vinterviken outside Stockholm until 1870. After a trip to the Caucasus in 1873, Robert Nobel became a pioneer in the Baku oil industry. In 1881, he ended his active participation in the company and returned to Sweden.",
				"Emanuel Nobel (1859–1932) was Alfred Nobel's nephew. After the death of his father, Ludvig Nobel, he took over leadership of the Nobel brothers’ oil company, Branobel. At first, Alfred Nobel doubted Emanuel’s ability to run the large company, but over time Emanuel proved his competance.",
				"Although Alfred Nobel never married, he had a long relationship with an Austrian woman, Sofie Hess (1851–1919). They met during a visit to Baden bei Wien in 1876. While at first Alfred was happy and in love, their relationship was anything but harmonious. He became dissatisfied with Sofie and scolded her for being irresponsible and childish. Their drawn-out and uneasy relationship finally came to an end in 1890, when Sofie became pregnant. The father was another man, Nicolaus Kapy von Kapivar, whom she eventually married.",
				"Alarik Liedbeck (1834–1912) was Alfred Nobel's childhood friend. In 1866, Liedbeck became head of the nitroglycerin factory at Vinterviken outside Stockholm. He remained in this position until 1875, but worked with Alfred Nobel on the establishment of new factories abroad. In 1876, Liedbeck moved to Paris to work for the Nobel company’s “syndicate,” which provided technical consultation to dynamite factories in other countries. Although Liedbeck returned to Stockholm in 1879, his collaboration with Alfred Nobel continued until his death.",
			...
			["Georges Fehrenbach was Alfred Nobel’s lab assistant in Paris, and later in the Sèvran laboratory and the dynamite factory in Ardeer, Scotland. Fehrenbach collaborated on the development of blasting gelatin and ballistite. When Nobel moved to San Remo in the beginning of the 1890s, Fehrenbach chose not to follow him and remained in Paris.",
                "The executors of the will had to create the fund from the portion of Nobel's fortune designated for the prizes. To do this, his shares, obligations and other valuable papers had to be transferred into cash. In 1900, the Nobel Foundation was established and given the responsibility of administering the fortune, as well as organizing the distribution of the prizes.",
			    "The Nobel Prizes were established in Alfred Nobel’s will, but the will provided no directions for how they were to be presented. December 10, the date of Alfred Nobel’s death, was designated as the day on which laureates would receive their awards. The prizes are presented with a medal and a diploma. The presentation of the Peace Prize takes place in Oslo, while all other prizes are awarded in Stockholm.",
                "Alfred Nobel wanted to reward achievements for the \"benefit to mankind\". The phrase is an important guide for the activities of the Nobel Foundation and its subsidiary organizations, as well as the prize-awarding institutions. However, it has not been entirely clear how to interpret the phrase. Should it be given a wide interpretation, for example that new knowledge is beneficial and will have mainly good consequences? Or should it be given a narrower interpretation, as something that has had direct practical use? The prize-awarding institutions have often chosen the wider definition and, for example, rewarded fundamental scientific discoveries that have not yet had practical applications.",
                "Physics is the first prize mentioned in Nobel's will. Physics was regarded as the most fundamental of the sciences, an opinion probably held by Nobel as well. In addition, physics was also closely related to his own area of research.",
			    "Chemistry was the second prize area Nobel mentioned in his will. In the era in which Alfred Nobel lived, belief in the potential of science and technology was very strong. Nobel was interested in many areas of science, including some which lay outside his own expertise. However, certain fields were especially important for his own work as an inventor, in particular chemistry.",

                "Physiology or medicine was the third prize area that Nobel mentioned in his will. He had a strong interest in medicine, partly as a result of his obsession with his own illnesses. \n"
                + "Nobel was also actively interested in medical research. Around 1890, through Karolinska Institutet in Stockholm, he met the physiologist, Jöns Johansson, who came to work at Nobel’s laboratory in Sevran.",


                "The fourth prize area Nobel mentioned in his will was literature. His literary interests, which began early in Nobel’s youth, lasted throughout his life. In his final years, he returned to writing fiction. His library contains a rich spectrum of literary works in different languages. \n",
                "A note by an official at the district court in Karlskoga, Sweden confirming that that Alfred Nobel's will has been received by the court.",
			],
			[
                "Peace was the fifth and final prize area that Nobel mentioned in his will. Alfred Nobel was interested in social issues, and had a special interest in the peace movement. Nobel’s interest in world peace was inspired by both his acquaintance with Bertha von Suttner, and by the use of his inventions in war and terrorist attacks. \n",
                "The Royal Swedish Academy of Sciences was formed in 1739 by Carl Linnaeus and a number of other Swedish scientists. It is an independent organization whose overall objective is to promote the sciences and strengthen their influence in society. In 1884, Alfred Nobel became a foreign member of the academy.",
                "Karolinska Institutet is a medical university in Stockholm, Sweden. It was founded in 1810 on Kungsholmen on the west side of Stockholm. The main campus was relocated decades later to Solna, just outside Stockholm. The donation made in the will was not the first that Alfred Nobel made to Karolinska Institutet. In 1890 he donated 50,000 Swedish kroner to the institute in order to create a fund in the memory of his mother, Andriette Nobel.",
                "When Alfred Nobel wrote “the Academy in Stockholm,” it was not entirely clear whether he meant the Swedish Academy or the Royal Academy of Sciences. However, the phrase was interpreted to mean the Swedish Academy. The Swedish Academy was founded in 1786 by King Gustav III. The primary purpose of the Academy is to further the “purity, strength, and sublimity of the Swedish language”.",
                "At the time when Alfred Nobel wrote his will, Sweden and Norway were joined in a union with a common foreign policy. Norway had a parliament, the Storting, and Alfred Nobel tasked the Storting with electing a committee to award the Peace Prize. Despite its members being appointed by a parliament, the committee is a private body.",
                "Over the course of his life, Alfred Nobel lived in many different places. This is an important background to his express wish that no consideration be given to the nationality of the Nobel Prize candidates.",
                "Ragnar Sohlman (1870–1948) was Alfred Nobel’s assistant during the years 1893–96. He began his career with Nobel in Paris, later worked with him in San Remo, and then in the laboratory at Bofors, Sweden in 1896–97. In Alfred Nobel’s will, Sohlman, along with Rudolph Lilljequist, was appointed an executor of Nobel’s estate. It was largely due to Sohlman’s work that the Nobel Foundation could be established in 1900. Sohlman was the acting director of the Nobel Foundation during the period 1929–1946.",
                "Later in life, Nobel took an interest in ammunition and weapons technology. In 1893 he bought the weapons factory at Bofors, outside the town of Karlskoga in western Sweden. There, Björkborn mansion became Nobel's last home in Sweden. His assistant, Ragnar Sohlman, worked at the laboratory of the factory.",
                ...
                + "Russia		5,232,773.45 \n"
                + "Total		33,233,792.20 \n", 
                "In his youth, Alfred Nobel spent time in Paris. At the age of 40, he bought a house there. His previous home in Hamburg had had more of a provisory nature, as he had spent most of his time traveling. He continued to travel extensively after moving to Paris, but he had definitely found a more permanent residence in a home that reflected his financial, social and cultural status.",
                "In several respects, the early 1890s were difficult for Alfred Nobel. He experienced serious health problems, increasing business worries, and suffered a painful breakup with his long-time mistress Sofie Hess. Around 1890, Alfred Nobel decided to leave Paris and in 1891 bought a villa in San Remo, Italy. A few years into the 1890s, Nobel’s problems had subsided, and he approached his various pursuits with renewed energy.",
                "A note by an official at the district court in Karlskoga, Sweden confirming that that Alfred Nobel's will has been received by the court.",
			],
			[
                "Alfred Nobel's incomes came from different sources. The companies he had established with various business partners generated profits, from which Nobel received a share. He held approximately 355 patents in different countries, which also generated incomes.",
